...
> [!NOTE]
> 이 페이지의 정보는 해당 지역의 새 데이터 센터가 시작 되기 전에 기존 Microsoft 365 테 넌 트가 있었던 고객 에게만 적용 됩니다. 또한 마이그레이션 자격은 특정 작업의 프로 비전 날짜에 따라 달라 지기 때문에 테 넌 트 생성 날짜는 항상 중요 한 단일 날짜가 아닐 수도 있습니다.
