 ...
 **테넌트 위치**는 [데이터 센터 맵](http://aka.ms/datamaps)을 사용하여 확인할 수 있습니다.
...
1. [CIDR 계산기](http://jodies.de/ipcalc)를 사용하여 IP 주소가 더 큰 게시된 범위에 포함되는지 확인합니다.
