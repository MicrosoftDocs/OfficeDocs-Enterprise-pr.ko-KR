...
**2017 년 4 월 11**Exchange Server 2007에는 지원의 끝에 도달 합니다. Office 365에 Exchange 2007 또는 Exchange 2016에서 마이그레이션을 시작한 이미 하지 않은 경우 지금 계획 수립 시작 시간을 됩니다. 
  
## <a name="what-does-end-of-support-mean"></a>지원 의미의 역할 끝 무엇입니까?

Exchange Server 같은 거의 모든 Microsoft 제품의 새로운 기능, 버그 수정, 보안 픽스 등에 제공 하는 동안 지원 주기를 있습니다. 이 수명 주기는 일반적으로 제품의 초기 릴리스 날짜 로부터 10 년 동안 지속 하 고이 주기 끝이 제품의 지원 종료 라고 합니다. Exchange 2007 2017 년 4 월 11에서 지원의 끝에 도달 하면 이후 Microsoft 더이상 제공 합니다.
...
Exchange 2007의 설치 계속이 날짜 이후에 실행 됩니다. 그러나 위에 나열 된 변경으로 인해 좋습니다 마이그레이션하는 Exchange 2007에서 가능한 한 빨리.
  
Office 2007 서버 지원 종료를 거의 가득 차지 하는 방법에 대 한 자세한 내용은 [Office 2007 서버 및 제품에서 업그레이드를 계획](upgrade-from-office-2007-servers-and-products.md)을 참조 하십시오.
  
## <a name="what-are-my-options"></a>내 옵션은 무엇입니까?

Exchange 2007 지원의 끝에 도달 하면 했으므로 것이 좋습니다 옵션을 탐색 하 고 마이그레이션 계획을 준비 합니다. 당신은 할 수 있어요:
  
- 단독, 미리 구성 된, Office 365를 사용 하 여 또는 하이브리드 마이그레이션;로 마이그레이션
    
- 온-프레미스 서버에 최신 버전의 Exchange Exchange 2007 서버를 마이그레이션하십시오.
    
다음 섹션에서는 각 옵션을에 대 한 자세한 정보를 살펴봅니다.
  
### <a name="migrate-to-office-365"></a>Office 365로 마이그레이션

Office 365로 전자 메일 마이그레이션에 가장 하 고 이해 하기 쉬운 하는 옵션은 Exchange 2007 배포 사용을 중지 하는 데 도움이 됩니다. Office 365로의 마이그레이션와 같은 최신 기능에 10 년의 역사 기술에서 단일 홉을 지정할 수 있습니다.
...
|미리 구성된 마이그레이션  <br/> |150 개 이상의 시트  <br/> |몇 주  <br/> |
|전체 하이브리드 마이그레이션  <br/> |다양 한 제공할 때 백 여러  <br/> |몇 개월 이상  <br/> |
...
- Office 365 TCP 포트 443;을 통해 외부에서 Outlook 사용을 사용 하 여 Exchange 2007 서버에 연결 해야 합니다.
    
- Office 365;로 모든 온-프레미스 사서함을 이동할
    
- 사용자의 사서함;의 콘텐츠를 읽을 수 있는 권한이 있는 온-프레미스 관리자 계정이 필요 합니다.
    
- Exchange 2007을 사용 하 여 Office 365 필요 서비스;에서 확인 된 도메인으로 추가 하려는 도메인을 허용
...
여기서 몇 백 또는 몇 천 사서함을 Office 365로 마이그레이션하는 경우 마이그레이션을 완료 하는 주 이상를 수행할 필요가을 해야 하 고 필요한 고급 하이브리드 마이그레이션 기능을 원치 않으면 공유 약속 있음/없음 일정 정보 하나는 미리 구성 된 마이그레이션 rmation 합니다.
  
미리 구성 된 마이그레이션은 자신의 사서함을 Office 365 마이그레이션 하지만 여전히 몇 주 내 마이그레이션을 완료 하려면 더 많은 시간을 수행 하는 조직에 적합 합니다. "일괄 처리" 및 해당 수를 제어를 사용할 수 있는에서 사서함을 마이그레이션할 수 있습니다, 지정된 된 시간에 사서함 마이그레이션됩니다. 동일한 부서에서 사용자의 사서함을 일괄 처리 수, 등 있는지 확인 하는 모든 이동 때 동시에 있습니다. 또는 마지막 일괄 처리 될 때까지 경영진의 사서함을 남길 수 있습니다. 으로 자신의 Outlook 프로필을 다시 만들려면 단독형 마이그레이션을 사용자에 게 해야 합니다.
...
- 전체 이름으로 CSV 파일을 만들고 일괄 처리에서 마이그레이션할 각 사서함의 전자 메일 주소 필요 합니다. 또한을 마이그레이션하는 경우 각 사서함에 대 한 새 암호를 포함 한 다음 각 사용자에 게 자신의 암호를 보내는 필요 합니다. 사용자가 새로운 Office 365 사서함;에 로그인 할 처음으로 암호를 변경 하 라는 메시지가 표시 됩니다.
    
- 마이그레이션 일괄 처리를 시작 하는 시기 사이 및 완료 단계를 시작 하는 경우 Office 365가 정기적으로 일괄 처리에 포함 된 Office 365 및 온-프레미스 사서함을 동기화 합니다. 이렇게 하면가 온-프레미스 사서함;에 남아 있는 전자 메일에 대 한 걱정 없이 마이그레이션 완료
    
- 사용자가 처음으로; 자신의 사서함에 로그인 할 때 변경 하는데 필요한 해당 Office 365 계정의 새 임시 암호를 받게 됩니다.
    
- 마이그레이션할 각 사용자 사서함에 대 한 Exchange Online을 포함 하는 Office 365 라이선스가 필요 합니다.
    
- 사용자가 각각의 해당 장치에 새 Outlook 프로필을 설정 하 고 전자 메일을 다시 다운로드 해야 합니다. Outlook를 다운로드 하는 전자 메일의 양을 달라질 수 있습니다. 자세한 내용은 [오프 라인으로 유지 하려면 얼마나 많은 메일 변경](https://support.office.com/en-us/article/Change-how-much-mail-to-keep-offline-f3a1251c-6dd5-4208-aef9-7c8c9522d633?ui=en-US&amp;rs=en-US&amp;ad=US&amp;fromAR=1)에 대 한 정보를 수행 합니다.
    
미리 구성 된 마이그레이션에 대 한 자세한 내용은,에 대 한 정보를 수행 합니다.
  
- [Office 365로 미리 구성 된 전자 메일 마이그레이션에 대해 알고 하는데 필요한](https://support.office.com/en-us/article/What-you-need-to-know-about-a-staged-email-migration-to-Office-365-7e2c82be-5f3d-4e36-bc6b-e5b4d411e207)
    
- [전자 메일을 Office 365의 미리 구성 된 마이그레이션 수행](https://support.office.com/en-us/article/Perform-a-staged-migration-of-email-to-Office-365-83bc0b69-de47-4cc4-a57d-47e478e4894e)
...
- "하이브리드 서버"로 사용할 Exchange 2007 조직에서 하나 이상의 Exchange 2013 서버를 배포 해야 합니다. 이 서버에 Exchange 2007 서버;를 대신 하 여 Office 365와 통신
    
- Office 365 TCP 포트 443;을 통해 외부에서 Outlook 사용을 사용 하 여 "하이브리드 서버"에 연결 해야 합니다.
...
강력 하 게 Office 365로 마이그레이션하는 방법으로 최상의 값 및 사용자 경험을 얻을 수 있는 하 라고 생각 되, 하는 동안는 또한 이해 일부 조직에서는 자신의 전자 메일 온-프레미스 유지 해야 합니다. 이 규정 요구 사항으로 인해 수, 데이터를 진행 하는 다른 국가, 이와 같은식으로에 있는 데이터 센터에 저장 되지 않습니다. 전자 메일에서 온-프레미스 유지 하려는 경우에 Exchange 2010, Exchange 2013 또는 Exchange 2016 Exchange 2007 환경을 마이그레이션할 수 있습니다.
...
|**Exchange 버전**|**기능**|
|:-----|:-----|
|Exchange 2010  <br/> | 역할 기반 액세스 제어 (Acl 없이 사용 권한)  <br/>  Outlook Web Access 사서함 정책  <br/>  약속 있음/없음 공유 하 고 조직 간에 일정을 위임할 수 있는 기능  <br/> |
|Exchange 2013  <br/> | *Exchange 2010에서 기능 및...*  <br/>  세 서버 역할의 수를 줄이는 단순화 된 아키텍처 (사서함, 클라이언트 액세스, Edge 전송)  <br/>  데이터 손실 방지 정책 (DLP) 누수에서 중요 한 정보를 유지 하는  <br/>  크게 향상 된 Outlook Web App 환경  <br/> |
...
|**고려 사항**|**추가 정보**|
|:-----|:-----|
|지원 날짜의 끝  <br/> | Exchange 2007의 경우 다음과 같이 각 버전의 Exchange 지원 날짜의 끝을 있습니다.  <br/> **Exchange 2010** -년 1 월 2020  <br/> **Exchange 2013** -년 4 월 2023  <br/> **Exchange 2016** -년 10 월 2025  <br/>  일찍 지원 날짜의 끝는 빠르게 다른 마이그레이션을 수행 하기 위해 필요 합니다. 1 월 2020은 생각 보다 훨씬 더 가깝게!<br/> |
|Exchange 2010 및 2013에 대 한 마이그레이션 경로  <br/> |Exchange 2010 또는 Exchange 2013으로 마이그레이션에 대 한 일반 단계는 다음과 같습니다.  <br/> 기존 Exchange 2007 조직 이동 서비스 및 Exchange 2010 또는 2013 이동 사서함을 다른 인프라 및 공용 폴더를 Exchange 2010 또는 2013 서비스 해제 남아 있는 Exchange 2007 서버에 Exchange 2010 또는 2013 설치 |
|Exchange 2016에 대 한 마이그레이션 경로  <br/> |Exchange 2016로 마이그레이션하기 위한 일반 단계는 다음과 같습니다.  <br/> 기존 Exchange 2007 조직 이동 서비스 및 Exchange 2013 이동 사서함을 다른 인프라 및 Exchange 2007 서버를 설치 하는 Exchange 2016 기존에 남아 있는 Exchange 2013 서비스 해제를 공용 폴더에 Exchange 2013을 설치 Exchange 2013 조직입니다. 사서함, 공용 폴더, 서비스 및 기타 인프라 Exchange 2016 (순서는 중요 하지 않습니다.)으로 이동 합니다. 나머지 Exchange 2013 서버를 해제 > [!NOTE]> Exchange 2016로 Exchange 2013에서 마이그레이션은 간단 합니다. 두 버전 모두에 거의 동일한 되는 하드웨어 요구 사항은 합니다. 이러한 버전은 Exchange 2013에 대 한 구입 하는 서버를 다시 작성 하 고 Exchange 2016 설치 호환 되는, 의미 하므로 팩트 및이 및 온라인 사서함 이동 개의 대부분의 사용자가 자신의 사서함 이동 하는 서버를 해제 한 후 다시 구축 했을 때 Exchange 2016와 후을 다시 확인 하지 못할 수 있습니다.           |
|버전 동시 사용  <br/> | 마이그레이션 하는 경우:  <br/> **Exchange 2016** Exchange 2007 서버를 포함 하는 조직에 Exchange 2016은 설치할 수 없습니다. 먼저 Exchange 2010 또는 2013 (라우팅하는 Exchange 2013)로 마이그레이션할 모든 Exchange 2007 서버를 제거 하 고 Exchange 2016 마이그레이션 후에 필요 합니다.<br/> **Exchange 2010 또는 Exchange 2013** 기존의 Exchange 2007 조직에 Exchange 2010 또는 Exchange 2013을 설치할 수 있습니다. 이 옵션을 사용 하면 하나 이상의 Exchange 2010 또는 2013 서버를 설치 하 고 마이그레이션을 수행할 수 있습니다.<br/> |
|서버 하드웨어  <br/> | Exchange 2007에서 서버 하드웨어 요구 사항이 변경 되었습니다. 사용 하려는 하드웨어 호환 되는지 확인 해야 합니다. 여기에 각 버전에 대 한 하드웨어 요구 사항에 대 한 자세한 내용을 찾을 수 있습니다.<br/> [Exchange 2016 시스템 요구 사항](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.160%29.aspx) <br/> [Exchange 2013 시스템 요구 사항](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.150%29.aspx) <br/> [Exchange 2010 시스템 요구 사항](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.141%29.aspx) <br/>  가 중요 한 Exchange 성능 향상는 컴퓨팅 향상 된 기능 및 새로운 서버에 저장 용량 가능성이 해야 같은 수의 사서함을 지원 하기 위해 적은 수의 서버를 찾을 수 있습니다.  <br/> |
|운영 체제 버전  <br/> | 각 버전에 대해 지원 되는 최소 운영 체제 버전 있습니다.  <br/> **Exchange 2016** Windows Server 2012  <br/> **Exchange 2013** Windows Server 2008 R2 SP1  <br/> **Exchange 2010** Windows Server 2008 s p 2  <br/>  [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 운영 체제 지원에 대 한 자세한 정보를 찾을 수 있습니다.  <br/> |
|Active Directory 포리스트 기능 수준  <br/> | 최소 지원 되는 Active Directory 포리스트 기능 수준 각 버전에 대 한 됩니다.  <br/> **Exchange 2016** Windows Server 2008 R2 SP1  <br/> **Exchange 2013** Windows Server 2003  <br/> **Exchange 2010** Windows Server 2003  <br/>  [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 포리스트 기능 수준 지원에 대 한 자세한 정보를 찾을 수 있습니다.  <br/> |
|Office 클라이언트 버전  <br/> | 각 버전에 대 한 최소 지원 되는 Office 클라이언트 버전 있습니다.  <br/> **Exchange 2016** Office 2010 (최신 업데이트로)  <br/> **Exchange 2013** Office 2007 s p 3  <br/> **Exchange 2010** Office 2003  <br/>  [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 Office 클라이언트 지원에 대 한 자세한 정보를 찾을 수 있습니다.  <br/> |
...
- Exchange [2016](https://technet.microsoft.com/EN-US/library/bb738144%28v=exchg.160%29.aspx), [2013](https://technet.microsoft.com/EN-US/library/bb738144%28v=exchg.150%29.aspx), [2010](https://www.microsoft.com/download/en/details.aspx?displaylang=en&amp;id=5401) 에 대 한 active Directory 스키마 변경 사항
    
- 개발자를 위한 Exchange [2016](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.160%29.aspx), [2013](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.150%29.aspx), [2010](https://technet.microsoft.com/en-us/library/aa996719%28v=exchg.141%29.aspx) 시스템 요구 사항
    
- 개발자를 위한 Exchange [2016](https://technet.microsoft.com/en-us/library/bb691354%28v=exchg.160%29.aspx), [2013](https://technet.microsoft.com/en-us/library/bb691354%28v=exchg.150%29.aspx), [2010](https://technet.microsoft.com/en-us/library/bb691354%28v=exchg.141%29.aspx) 필수 구성 요소
...
[Office 2007 서버와 클라이언트를 업그레이드 하는데 도움이 되는 리소스](upgrade-from-office-2007-servers-and-products.md)
