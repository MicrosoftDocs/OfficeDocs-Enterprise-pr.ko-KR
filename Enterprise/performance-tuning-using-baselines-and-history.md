...
문제 해결 측면에서 이러한 초기 계획을 유지 하는 것 외에도 흥미로운 사항이 있을 수 있습니다. 예를 들어, 프록시 또는 송신 지점에서 Office 365 URL로의 대기 시간이 59 밀리초 인 40 것으로 확인 되 고 클라이언트에 프록시 또는 송신 지점 대기 시간이 약 3 ~ 7 밀리초 (seein 네트워크 트래픽 수에 따라 다름)가 되는 것을 확인할 수 있습니다. 이 시간 동안 g가 표시 되 면, 프록시 또는 egress 초기에 마지막 세 클라이언트에 대기 시간이 45 밀리초 인 경우 문제가 발생 하는 것을 알 수 있습니다.
