...
description: Microsoft Office 365 공동 작업, 보안 및 규정 준수, 이동성 및 intellgence 및 분석을 사용 하도록 설정 하는 강력한 온라인 클라우드 서비스를 제공 합니다. 이 페이지에서는 관리자 및 배포, 구성 및 엔터프라이즈 조직에서 Office 365 서비스를 관리 하는 IT 전문가 위한 지침을 제공 합니다.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>FastTrack 포함 하는 안내식된 배포</h3>
                <p>Office에 대 한 FastTrack 센터 혜택을 사용 하 여&nbsp;계획, 배포 및 Office 촉진 제어에 대 한 실무 안내 도움말에 대 한 365&nbsp;조직에 대 한 365 서비스입니다.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <p>Office를 사용 하도록 기존 온-프레미스 인프라 마이그레이션&nbsp;365와 Microsoft 클라우드 합니다.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <p>계획, 배포 및 관리 Office&nbsp;기업 환경에서 365 ProPlus 합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Office 365 배포</h3>
                <p>Office 배포&nbsp;, 테 넌 트를 설정 하 고, 네트워크를 구성 하 고, 사용자 프로 비전을 포함 하 여 365 합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>하이브리드 배포</h3>
                <p>구성 하 고 기존 온-프레미스 인프라와 Office 간의 하이브리드 배포 관리&nbsp;365 합니다.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Office 365 교육</h3>
                <p>사무실 개선&nbsp;office 365 지식과 관리 기술&nbsp;IT 전문가 위한 교육 코스를 통해 365 합니다.</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Office 365 작업 부하를 배포 합니다.</h2>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p><a href="https://techcommunity.microsoft.com/t5/Office-365/ct-p/Office365">모범 사례, 뉴스, 최신 추세 및 Office와 관련 된 항목에 대 한 설명&nbsp;365 합니다.</a></p>
                    </div>
                </div>
            </div>
        </div>
