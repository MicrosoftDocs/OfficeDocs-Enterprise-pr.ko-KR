...
-1 | 허용<BR>필수 | 예 | `*.gov.us.microsoftonline.com, graph.microsoft.us, graph.microsoftazure.us, login.microsoftonline.us`<BR>`20.140.232.0/23, 52.126.194.0/23` | **TCP:** 443
...
kb(56kbps | 허용<BR>필수 | 예 | `*.gov.microsoftstream.us`<BR>`20.140.160.0/24, 20.140.162.0/24` | **TCP:** 1935, 1936, 2935, 2936, 443
