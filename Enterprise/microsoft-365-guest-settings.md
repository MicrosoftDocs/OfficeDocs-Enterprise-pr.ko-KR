...
**탐색:** [Microsoft 365 관리 센터](https://admin.microsoft.com) > 설정 > 보안&개인 정보 보호 > 공유
...
**탐색:** [Microsoft 365 관리 센터](https://admin.microsoft.com) > 설정 > 서비스&추가 기능 > Office 365 그룹
...
**탐색:** SharePoint 관리 센터 > 활성 사이트 > 사이트 선택 > 공유
