...
- **비즈니스용 Skype 관련**
  ...
  - 모든 SFB 프런트 엔드에서 office 365 [url 및 IP의 ' Microsoft 125 일반 및 Office Online ' 섹션에 있는 office (internet 443)와 잘 알려진 인증서 루트 crl (tcp 80)에 대 한 연결이 인터넷으로 아웃 바운드 되어 있어야 합니다. 주소 범위](urls-and-ip-address-ranges.md)
...
- **Exchange Server 관련**
  ...
  - 사용자 환경에서 프록시 서버 인프라를 사용 하 여 서버에서 인터넷에 연결할 수 있도록 하는 경우 모든 Exchange 서버에는 [internetwebproxy](https://technet.microsoft.com/en-us/library/bb123716%28v=exchg.160%29.aspx) 속성에 정의 된 프록시 서버가 있어야 합니다.
