...
---
# <a name="office-365-security-incident-response"></a>Office 365 보안 문제 대응
...
- [검색 및 Office 365의에서 불법 사용자의 동의 부여 수정](detect-and-remediate-illicit-consent-grants.md)
- [검색 및 Outlook 규칙 및 Office 365에서에서 사용자 지정 양식 주입 공격 수정](detect-and-remediate-outlook-rules-forms-attack.md)
