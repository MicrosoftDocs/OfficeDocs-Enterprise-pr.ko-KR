...
## <a name="will-new-microsoft-365-customers-be-automatically-provisioned-in-the-new-datacenter-geos"></a>새로운 Microsoft 365 고객은 새 데이터 센터 geos에서 자동으로 프로 비전 됩니까?
  
예. 새 데이터 센터 geo를 사용할 수 있게 되 면 새 지역에 등록 하는 동안 국가를 선택 하는 새로운 Microsoft 365 고객에 게는 새 데이터 센터 지역에 나머지 사용자의 핵심 고객 데이터가 저장 됩니다.
