...
Office 2010 서버 지원 종료를 거의 가득 차지 하는 방법에 대 한 자세한 내용은 [2010 서버와 클라이언트가 Office에서 업그레이드 하는데 도움이 되는 리소스](https://docs.microsoft.com/en-us/office365/enterprise/upgrade-from-office-2010-servers-and-products)를 참조 합니다.
...
- Office 365에 완전히를 마이그레이션하십시오. 단독, 최소한의 하이브리드 또는 전체 하이브리드 마이그레이션을 사용 하 여 사서함 마이그레이션 후 제거 온-프레미스 Exchange 서버 및 Active Directory 합니다.
- 온-프레미스 서버에 Exchange 2016 하 여 Exchange 2010 서버를 마이그레이션하십시오.

> [!IMPORTANT]
> 조직의 Office 365로 사서함 마이그레이션 하기로 결정 하 고 계속 온-프레미스 Active Directory에서 사용자 계정을 관리 하는 위치에 DirSync 또는 Azure AD 연결을 유지 하려면 적용 하려는 하나 이상의 Exchange server 온-프레미스 유지 해야 합니다. 마지막 Exchange server을 제거한 경우에 Exchange Online의 Exchange 받는 사람에 게 변경할 수 없습니다. 권한 원본을 온-프레미스 Active Directory에서 유지 되 고 다음과 같은 내려야 하 변경 해야 하기 때문에입니다. 이 시나리오에서는 다음 옵션 있습니다.

- (**권장**) Office 365로 사서함을 마이그레이션할 하 고 2020 년 1 월 14 하 여 서버를 업그레이드 하는 경우 Exchange 2010을 사용 하 여 Office 365에 연결 하 여 사서함을 마이그레이션합니다. 다음으로, Exchange 2016 Exchange 2010으로 마이그레이션 및 나머지 모든 Exchange 2010 서버 역할을 해제 합니다.
- 사서함 마이그레이션을 완료할 수 없습니다 2020, 년 1 월 14 하 여 온-프레미스 서버 업그레이드 Exchange 2016를 먼저 온-프레미스 Exchange 2010 서버를 업그레이드 하는 경우 사용 하 여 Exchange 2016 Office 365에 연결 하 고 사서함을 마이그레이션합니다.

> [!NOTE]
> 약간 더 복잡 하는 동안 Exchange 2016 하 여 온-프레미스 Exchange 2010 서버를 마이그레이션하는 동안 Office 365로 사서함을도 마이그레이션할 수 있습니다.
...
| **마이그레이션 옵션**     | **조직 크기** | **기간**        |
|--------------------------|-----------------------|---------------------|
| 단독형 마이그레이션        | 미만의 150 시트  | 한 주 이내      |
| 최소한의 하이브리드 마이그레이션 | 미만의 150 시트  | 몇 주 이내 |
| 전체 하이브리드 마이그레이션    | 150 개 이상의 시트   | 몇 주 이상 |
...
### <a name="minimal-hybrid-migration"></a>최소한의 하이브리드 마이그레이션

최소한의 하이브리드 또는 express, 마이그레이션 하나인 몇 백 사서함을 Office 365로 마이그레이션할 하 몇 주 내에 마이그레이션을 완료할 수 및 공유 약속 있음/없음 일정 같은 고급 하이브리드 마이그레이션 기능 중 하나 필요는 없습니다 하는 있는 경우 정보입니다.

최소한의 하이브리드 마이그레이션은 Office 365 하지만 여전히 몇 주 내 마이그레이션을 완료 하려면 계획으로 자신의 사서함에 더 많은 시간이 걸릴 하는 조직에 적합 합니다. 복잡 한 문제 없이 고급 전체 하이브리드 마이그레이션의 일부 이점을 얻을 수 있습니다. 및 해당, 수, 사서함을 제어할 수 있습니다, 지정된 된 시간에 마이그레이션됩니다 사용자 이름 및 해당 온-프레미스 계정의 암호 사용 하 여 office 365 사서함을 만들어집니다. 및 단독형 마이그레이션와는 달리 사용자가 자신의 Outlook 프로필을 다시 필요 하지 않은 합니다.

최소한의 하이브리드 마이그레이션을 수행 하는 방법에 대 한 생각 하면 몇가지 사항을 고려해 야 다음과 같습니다.
...
최소한의 하이브리드 마이그레이션에 대 한 자세한 내용은 [신속 하 게 Office 365로 Exchange 사서함을 마이그레이션할 최소한의 하이브리드 사용에](https://support.office.com/article/Use-Minimal-Hybrid-to-quickly-migrate-Exchange-mailboxes-to-Office-365-fdecceed-0702-4af3-85be-f2a0013937ef) 대 한 정보를 수행 합니다.
...
- 전체 하이브리드 마이그레이션은 모든 유형의 조직에 적합 하지 않습니다. 전체 하이브리드 마이그레이션의 복잡성으로 인해 보다 작은 몇 백 사서함이 있는 조직에서는 작업량 및 비용 하나를 설정 하는 데 필요한 justify 혜택을 일반적으로 표시 되지 않습니다. 조직 처럼 소리이 하는 경우는 것이 좋습니다 단독 또는 최소한의 하이브리드 마이그레이션을 대신; 고려
...
> [!IMPORTANT]
> 조직의 Office 365로 사서함 마이그레이션 하기로 결정 하 고 계속 온-프레미스 Active Directory에서 사용자 계정을 관리 하는 위치에 DirSync 또는 Azure AD 연결을 유지 하려면 적용 하려는 하나 이상의 Exchange server 온-프레미스 유지 해야 합니다. 마지막 Exchange server을 제거한 경우에 Exchange Online의 Exchange 받는 사람에 게 변경할 수 없습니다. 권한 원본을 온-프레미스 Active Directory에서 유지 되 고 다음과 같은 내려야 하 변경 해야 하기 때문에입니다.
...
## <a name="upgrade-to-a-newer-version-of-exchange-server-on-premises"></a>새 버전의 Exchange Server 온-프레미스 업그레이드

강력 하 게 Office 365에 완벽 하 게 마이그레이션하는 방법으로 최상의 값 및 사용자 경험을 얻을 수 있는 하 라고 생각 되, 하는 동안는 또한 이해 일부 조직에서는 일부 Exchange 서버 온-프레미스 유지 해야 합니다. 이 데이터는 다른 국가에 있는 데이터 센터에 저장 되지 않습니다 또는 고유 설정 또는 요구 사항, 클라우드에서 충족할 수 없는 때문일 수 있습니다.를 보장 하기 위해 규정 요구 사항으로 인해 수 또는 해야 하도록 Exchange은 단순히 될 수 있습니다. Active Directory 온-프레미스를 계속 사용 하기 때문에 클라우드 사서함을 관리 합니다. 어떤 경우에 선택 하거나 Exchange 온-프레미스 유지 해야하는에 대 한 확인 해야 적어도 Exchange 2013을 Exchange 2010 환경의 업그레이드 또는 Exchange 2016 및 Exchange 2010 지원의 끝 날짜 전에 제거 됩니다.

최상의 경험에 대 한 Exchange 2016 나머지 온-프레미스 환경을 업그레이드 하는 것이 좋습니다. Exchange Server 2010에서 Exchange Server 2016로 이동 하려는 경우 Exchange Server 2013을 설치할 필요가 없습니다.

모든 기능 및 이전 버전의 Exchange 포함 하는 고급 기능을 통해 Exchange 2016를 포함 하 고 (Office 365에만 사용할 수 있는 일부 기능 이지만) Office 365와 함께 사용할 수 있는 환경에서 가장 근접 하 게 일치 합니다. 제한 하면 했을 때 된 누락에이 문서는 몇을 확인해보세요.

| **Exchange 버전**                     | **기능**                                                                                                                                                                                                                                         |
|------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Exchange 2013                            | 세 서버 역할의 수를 줄이는 단순화 된 아키텍처 (사서함, 클라이언트 액세스, Edge 전송)                                                                                                                                        |
|                                          | 데이터 손실 방지 정책 (DLP) 누수에서 중요 한 정보를 유지 하는                                                                                                                                                                |
|                                          | 크게 향상 된 Outlook Web App 환경                                                                                                                                                                                                    |
| Exchange 2016                            | *Exchange 2013의 기능 및...*                                                                                                                                                                                                                   |
|                                          | 사서함 및 Edge 전송 방금 단순화 된 서버 역할 추가                                                                                                                                                                                   |
|                                          | SharePoint와의 통합 함께 향상 된 DLP                                                                                                                                                                                                  |
|                                          | 향상 된 데이터베이스 복구                                                                                                                                                                                                                         |
|                                          | 온라인 문서 공동 작업                                                                                                                                                                                                                        |

| **고려 사항**                        | **추가 정보**                                                                                                                                                                                                                                        |
|------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 지원 날짜의 끝                     | Exchange 2010의 경우 다음과 같이 각 버전의 Exchange 지원 날짜의 끝을 있습니다.                                                                                                                                                                        |
|                                          | **Exchange 2013** -년 4 월 2023                                                                                                                                                                                                                       |
|                                          | **Exchange 2016** -년 10 월 2025                                                                                                                                                                                                                     |
|                                          | 일찍 지원 날짜의 끝는 빠르게 다른 마이그레이션을 수행 하기 위해 필요 합니다. 4 월 2023은 생각 보다 훨씬 더 가깝게!                                                                                                                 |
| Exchange 2013 또는 2016에 대 한 마이그레이션 경로  | 최신 버전으로 Exchange 2010에서 마이그레이션 경로 하 든 상관 없이 Exchange 2013 또는 Exchange 2016 동일 합니다.                                                                                                                              |
|                                          | 기존 Exchange 2010 조직 이동 서비스 및 Exchange 2013 또는 2016 이동 사서함을 다른 인프라 및 공용 폴더를 Exchange 2013 또는 2016 서비스 해제 남아 있는 Exchange 2010 서버에 Exchange 2013 또는 2016 설치  |
| 버전 동시 사용                      | Exchange 2013 또는 Exchange 2016으로 마이그레이션할 때 기존 Exchange 2010 조직에 두 버전을 설치할 수 있습니다. 이 옵션을 사용 하면 하나 이상의 Exchange 2013 또는 Exchange 2016 서버를 설치 하 고 마이그레이션을 수행할 수 있습니다.             |
| 서버 하드웨어                          | 서버 하드웨어 요구 사항 Exchange 2010에서 변경 되었습니다. 사용 하려는 하드웨어 호환 되는지 확인 해야 합니다. 여기에 각 버전에 대 한 하드웨어 요구 사항에 대 한 자세한 내용을 찾을 수 있습니다.                                      |
...
|                                          | 가 중요 한 Exchange 성능 향상는 컴퓨팅 향상 된 기능 및 새로운 서버에 저장 용량 가능성이 해야 같은 수의 사서함을 지원 하기 위해 적은 수의 서버를 찾을 수 있습니다.                       |
| 운영 체제 버전                 | 각 버전에 대해 지원 되는 최소 운영 체제 버전 있습니다.                                                                                                                                                                                |
|                                          | **Exchange 2016** Windows Server 2012                                                                                                                                                                                                                |
|                                          | **Exchange 2013** Windows Server 2008 R2 SP1                                                                                                                                                                                                         |
|                                          | [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 운영 체제 지원에 대 한 자세한 정보를 찾을 수 있습니다.                                                                        |
| Active Directory 포리스트 기능 수준 | 최소 지원 되는 Active Directory 포리스트 기능 수준 각 버전에 대 한 됩니다.                                                                                                                                                                |
|                                          | **Exchange 2016** Windows Server 2008 R2 SP1                                                                                                                                                                                                         |
|                                          | **Exchange 2013** Windows Server 2003                                                                                                                                                                                                                |
|                                          | [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 포리스트 기능 수준 지원에 대 한 자세한 정보를 찾을 수 있습니다.                                                                 |
| Office 클라이언트 버전                   | 각 버전에 대 한 최소 지원 되는 Office 클라이언트 버전 있습니다.                                                                                                                                                                                   |
|                                          | **Exchange 2016** Office 2010 (최신 업데이트로)                                                                                                                                                                                              |
|                                          | **Exchange 2013** Office 2007 s p 3                                                                                                                                                                                                                    |
|                                          | [Exchange 지원 가능성 행렬](https://technet.microsoft.com/en-us/library/ff728623%28v=exchg.150%29.aspx)에서 Office 클라이언트 지원에 대 한 자세한 정보를 찾을 수 있습니다.                                                                           |

마이그레이션 도움이 되는 다음 리소스를 사용할 수 있습니다.
...
[2010 서버와 클라이언트에서 Office를 업그레이드 하는데 도움이 되는 리소스](https://docs.microsoft.com/en-us/office365/enterprise/upgrade-from-office-2010-servers-and-products)
