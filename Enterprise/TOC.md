...
## Office 클라이언트 및 서버
### [업그레이드 계획](plan-upgrade-previous-versions-office.md)
### Office 2007
...
### [Azure 권한 관리](activate-rms-in-office-365.md)
### [릴리스 옵션 구성](https://support.office.com/article/365-3b3adfa4-1777-4ff0-b606-fb8732101f47)
...
## 디렉터리 동기화
### [디렉터리 동기화 상태 보기](view-directory-synchronization-status.md)
### [디렉터리 동기화 오류 확인](identify-directory-synchronization-errors.md)
### [디렉터리 동기화 문제 해결](fix-problems-with-directory-synchronization.md)
...
### [성능 문제 해결 계획](performance-troubleshooting-plan.md)
...
## [Microsoft 클라우드에서 암호화](\microsoft-365\compliance\office-365-encryption-in-the-microsoft-cloud-overview.md)
### [Office 365 서비스 암호화](\microsoft-365\compliance\office-365-service-encryption.md)
### [전송 중인 데이터 암호화](\microsoft-365\compliance\office-365-encryption-for-data-in-transit.md)
### [고객 관리 암호화 기능](\microsoft-365\compliance\office-365-customer-managed-encryption-features.md)
### [암호화 위험 및 보호](\microsoft-365\compliance\office-365-encryption-risks-and-protections.md)
### [비즈니스용 Skype, 비즈니스용 OneDrive, SharePoint 온라인 및 Exchange 온라인을 위한 암호화](\microsoft-365\compliance\office-365-encryption-for-skype-onedrive-sharepoint-and-exchange.md)
### [Microsoft Dynamics 365에서 암호화](\microsoft-365\compliance\office-365-encryption-in-microsoft-dynamics-365.md)
### [Azure의 암호화](\microsoft-365\compliance\office-365-azure-encryption.md)
