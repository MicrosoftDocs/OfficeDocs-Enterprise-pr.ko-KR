...
##### [Project Server에서 사용자 데이터를 삭제 합니다.](/Project/delete-user-data-from-project-server?toc=/Office365/Enterprise/toc.json)
#### [Office Online 서버에 대 한 GDPR](gdpr-for-office-online-server.md)
#### [파일 공유에 대 한 GDPR](gdpr-for-on-premises-file-shares.md)
