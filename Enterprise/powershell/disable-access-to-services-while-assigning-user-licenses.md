...
[PowerShell을 사용 하 여 Microsoft 365 서비스에 액세스할 수 없도록 설정](disable-access-to-services-with-office-365-powershell.md)
  
[PowerShell을 사용 하 여 Sway에 액세스 사용 안 함](disable-access-to-sway-with-office-365-powershell.md)
