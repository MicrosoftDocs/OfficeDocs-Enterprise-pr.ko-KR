...
Office 365 관리자로 중앙 집중화 배포를 통해 사용자에 게 Office 추가 기능을 배포할 수 있습니다 ( [Office 365 관리 센터에서 Office 365 추가 기능 배포를 관리](https://support.office.com/article/737e8c86-be63-44d7-bf02-492fa7cd9c3f)참조)는 기능입니다. Office 365 관리 센터를 통해 Office 추가 기능을 배포 하는 것 외에도 Microsoft PowerShell를 사용할 수 있습니다. [다운로드](https://go.microsoft.com/fwlink/p/?linkid=850850) 는 Microsoft 다운로드 센터에서 배포 PowerShell 중앙 집중화 cmdlet입니다. 
  
## <a name="what-do-you-want-to-do"></a>무슨 작업을 하고 싶으십니까?

[관리 자격 증명을 사용 하 여 연결](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_Connect)
  
[프로그램 추가 기능에서 매니페스트를 업로드 합니다.](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_UploadManifest)
  
[Office 스토어에서 추가 기능을 업로드합니다](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_UploadAddin)
  
[추가 기능에 대 한 정보를 봅니다.](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_GetDetails)
  
[켜기 또는의 프로그램 추가 기능을 해제합니다](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_TurnOnOff)
  
[추가 또는 추가 기능에서 사용자를 제거 합니다.](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_AddRemove)
  
[추가 기능을 업데이트 합니다.](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_UpdateAddin)
  
[추가 기능을 삭제 합니다.](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_Delete)
  
[각 cmdlet에 대 한 자세한 도움말을 보려면](use-the-centralized-deployment-powershell-cmdlets-to-manage-add-ins.md#BKMK_GetHelp)
