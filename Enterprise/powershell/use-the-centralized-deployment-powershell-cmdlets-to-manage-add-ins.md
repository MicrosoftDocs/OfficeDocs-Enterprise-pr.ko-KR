...
Microsoft 365 전역 관리자는 중앙 집중식 배포 기능을 통해 사용자에 게 Office 추가 기능을 배포할 수 있습니다 ( [관리 센터에서 Office 추가 기능 배포](https://docs.microsoft.com/microsoft-365/admin/manage/manage-deployment-of-add-ins)참조). 365 Microsoft PowerShell을 사용 하 여 Office 추가 기능을 배포 하는 것 외에도 [Windows PowerShell 용 O365 중앙화 된 추가 기능 배포 모듈](https://www.powershellgallery.com/packages/O365CentralizedAddInDeployment)을 설치 합니다. 
...
3. **자격 증명 입력** 페이지에서 Microsoft 365 전역 관리자 자격 증명을 입력 합니다. 또는 cmdlet에 직접 자격 증명을 입력할 수 있습니다. 
...
> [!NOTE]
> PowerShell을 사용 하는 방법에 대 한 자세한 내용은 [powershell로 Microsoft 365에 연결](https://go.microsoft.com/fwlink/p/?linkid=848585)을 참조 하세요. 
