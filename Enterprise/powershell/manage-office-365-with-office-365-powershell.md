...
*이 문서는 Office 365 및 Microsoft 365에 모두 적용 됩니다.*
...
- [시작](getting-started-with-office-365-powershell.md)
    ...
    Office 365 PowerShell에 익숙하고 office 365 PowerShell 모듈을 설치 하 고 Office 365 구독에 연결 하려면 여기에서 시작 합니다.

- [사용자 계정, 라이선스 및 그룹](manage-user-accounts-and-licenses-with-office-365-powershell.md)

    Office 365 PowerShell 모듈을 설치 했으며 자동화 명령을 사용 하 여 사용자 계정, 라이선스 및 그룹을 관리 하는 방법에 대해 자세히 알아보려면 여기에서 시작 합니다.
...
- [Office 365로의 전자 메일 마이그레이션](use-powershell-for-email-migration-to-office-365.md)

    Office 365 PowerShell 모듈을 설치했으며 기존 시스템에서 전자 메일을 마이그레이션하려면 여기에서 시작합니다.

- [보안 & 준수 센터](https://docs.microsoft.com/powershell/exchange/office-365-scc/office-365-scc-powershell)
