...
이 항목은 Microsoft 365에서 RMS를 사용 하도록 설정 하 고 사용 하는 방법을 설명 하는 항목을 가리킵니다.
...
- Microsoft 365 용 RMS를 정품 인증 하는 방법에 대 한 자세한 내용은 [Azure 권한 관리 정품 인증](https://technet.microsoft.com/library/jj658941.aspx)을 참조 하세요.
