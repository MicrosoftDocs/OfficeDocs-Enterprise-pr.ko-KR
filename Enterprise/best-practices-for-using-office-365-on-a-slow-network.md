...
Microsoft는 네트워크를 모니터링 하 고 대역폭과 대기 시간을 측정 하 고, 페이지 로드 시간을 높이 며, 디스크 i/o를 줄이고, 페이지를 최소 다운로드 전략을 사용 하 여 데이터 센터에 추가 하는 방법으로 Office 365의 전반적인 성과를 지속적으로 개선 하 고 있습니다. 더 많은 데이터 센터 추가 현재 상태 및 보고 문제를 확인 하는 방법에 대 한 자세한 내용은 How to 365 check service health를 참조 하십시오.
