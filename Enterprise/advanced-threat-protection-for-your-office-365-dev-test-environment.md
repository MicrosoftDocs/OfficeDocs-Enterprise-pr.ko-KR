...
14. **URL**입력 **http://www.spamlink.contoso.com/**, **확인**을 클릭 한 다음 **보내기**를 클릭 합니다.
    
15. 열기 개인 검색 모드에서 Internet Explorer의 별도 인스턴스를 이동 하 여 Office 365 포털에 ([https://portal.office.com](https://portal.office.com)), 전역 관리자 계정 사용 하 여 Office 365 평가판 구독에 로그인 합니다.
