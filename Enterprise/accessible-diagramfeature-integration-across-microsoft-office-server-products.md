...
<span data-ttu-id="2a9f5-109">다음과 같은 기능 및 탭을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-109">The features and tabs are:</span></span> 
...
3. <span data-ttu-id="2a9f5-128">**인쇄 설정** 탭의 **프린터 용지** 섹션에서 인쇄할 용지 크기를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-128">On the **Print Setup** tab, in the **Printer paper** section, select the size of paper you want to print on.</span></span>
...
- <span data-ttu-id="2a9f5-145">SharePoint</span><span class="sxs-lookup"><span data-stu-id="2a9f5-145">SharePoint</span></span>
...
- <span data-ttu-id="2a9f5-168">SharePoint</span><span class="sxs-lookup"><span data-stu-id="2a9f5-168">SharePoint</span></span>
...
- <span data-ttu-id="2a9f5-182">SharePoint Server 2013</span><span class="sxs-lookup"><span data-stu-id="2a9f5-182">SharePoint Server 2013</span></span> 
...
4. <span data-ttu-id="2a9f5-210">Exchange 서버는 액세스 토큰의 유효성을 검사 하 고 쿼리 결과를 전송 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-210">The Exchange server validates the access token and sends the query results.</span></span> 
...
- <span data-ttu-id="2a9f5-224">Exchange 2013와 Lync 2013 간의 두 가지입니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-224">Between Exchange 2013 and Lync 2013.</span></span> 
 ...
 <span data-ttu-id="2a9f5-225">**Exchange Server 2013**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-225">**On Exchange Server 2013**</span></span>
...
- <span data-ttu-id="2a9f5-242">SharePoint Server 2013에서 Exchange 2013 고해상도 사진 사용 (http://aka.ms/Bhr4d2)</span><span class="sxs-lookup"><span data-stu-id="2a9f5-242">Using Exchange 2013 high-resolution photos from SharePoint Server 2013 (http://aka.ms/Bhr4d2)</span></span> 
...
7. <span data-ttu-id="2a9f5-257">이제 레거시 Lync 클라이언트에 사진에 대 한 액세스 권한이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-257">The Legacy Lync client now has access to the photo.</span></span> 
...
- <span data-ttu-id="2a9f5-272">사용자가 Lync 2013을 사용 하 여 로그인 할 때 사용자나의 lync 연락처가 Exchange 2013로 자동으로 마이그레이션됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-272">Lync contacts for a user are migrated to Exchange 2013 automatically when the user logs in with Lync 2013.</span></span> 
...
## <a name="site-mailboxes-tab"></a><span data-ttu-id="2a9f5-287">사이트 사서함 탭</span><span class="sxs-lookup"><span data-stu-id="2a9f5-287">Site mailboxes tab</span></span>
...
- <span data-ttu-id="2a9f5-302">사이트 사서함 프로 비전 정책을 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-302">Create site mailbox provisioning policy.</span></span> 
...
<span data-ttu-id="2a9f5-316">다이어그램에는 다음을 비롯 하 여 사이트 사서함을 구축 하는 데 필요한 SharePoint의 구성 요소가 나와 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-316">A diagram shows the components on SharePoint that are required to provision the site mailbox, including:</span></span> 
...
- <span data-ttu-id="2a9f5-350">프로젝트 웹 응용 프로그램 사이트를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-350">Create Project Web Application sites.</span></span> 
...
<span data-ttu-id="2a9f5-366">Exchange 서버 2013에는 다음이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-366">Exchange Server 2013 contains the following:</span></span> 
...
- <span data-ttu-id="2a9f5-385">사용자가 Exchange 작업을 내 사이트와 동기화 하거나, SharePoint Server 2013 및 Project Server 2013 작업을 Exchange Server 2013과 함께 사용 하도록 옵트인 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-385">Users must opt in to synchronize their Exchange tasks with their My Site, or their SharePoint Server 2013 and Project Server 2013 tasks with Exchange Server 2013.</span></span> 
...
<span data-ttu-id="2a9f5-400">Outlook Web App 사용자의 경우 Exchange CAS는 사용자를 대신 하 여 현재 상태를 쿼리 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-400">For Outlook Web App users, Exchange CAS queries presence on behalf of the user.</span></span> 
...
- <span data-ttu-id="2a9f5-425">Exchange Server 2013</span><span class="sxs-lookup"><span data-stu-id="2a9f5-425">Exchange Server 2013</span></span> 
    
- <span data-ttu-id="2a9f5-426">Exchange Server 2013</span><span class="sxs-lookup"><span data-stu-id="2a9f5-426">Exchange Server 2013</span></span> 
    
 <span data-ttu-id="2a9f5-427">**작동 방법**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-427">**How it works**</span></span>
  
<span data-ttu-id="2a9f5-428">수신자의 활성 끝점에서 수신자가 호출에 응답 하지 않으면 Lync Server는 통화를 Exchange UM (예: Exchange 사서함 서버)의 음성 메일로 라우팅합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-428">When a call is not answered by the callee on any of the callee's active endpoints, Lync Server routes the call to voicemail on Exchange UM (i.e. Exchange Mailbox Server).</span></span> 
  
<span data-ttu-id="2a9f5-429">함께 제공 되는 다이어그램에서는 두 가지 시나리오에 대 한 호출 라우팅을 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-429">The accompanying diagram shows the routing of calls for two scenarios:</span></span> 
  
- <span data-ttu-id="2a9f5-430">발신자가 Lync 2013을 사용 하 여 전화를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-430">The caller initiates a call using Lync 2013.</span></span> 
    
- <span data-ttu-id="2a9f5-431">발신자가 PSTN 장치 (PBX, 셀룰러, POTS)를 사용 하 여 전화를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-431">The caller initiates a call using PSTN device (PBX, cellular, POTS).</span></span> 
    
<span data-ttu-id="2a9f5-432">발신자가 Lync 2013을 사용 하 여 전화를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-432">The caller initiates a call using Lync 2013:</span></span> 
  
1. <span data-ttu-id="2a9f5-433">발신자는 Lync 2013를 사용 하 여 수신자에 대 한 호출을 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-433">Caller A initiates a call to the callee using Lync 2013.</span></span> <span data-ttu-id="2a9f5-434">통화가 시작 되어 Lync Server로 전송 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-434">The call is initiated and sent to the Lync Server.</span></span> 
    
2. <span data-ttu-id="2a9f5-435">통화가 수신자의 Lync home 서버로 라우팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-435">The call is routed to the callee's Lync home server.</span></span> 
    
3. <span data-ttu-id="2a9f5-436">Lync Server는 Lync 2013에서 수신자의 활성 끝점을 울립니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-436">Lync Server rings the callee's active endpoints on Lync 2013.</span></span> 
    
4. <span data-ttu-id="2a9f5-437">호출이 응답 하지 않으면 통화가 Exchange CAS (통화 라우터)에서 음성 메일 (Exchange UM)으로 라우팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-437">When the call is not answered, the call is routed to voicemail (Exchange UM) on the Exchange CAS (call router).</span></span> 
    
<span data-ttu-id="2a9f5-438">발신자가 Lync 2013을 사용 하 여 전화를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-438">The caller initiates a call using Lync 2013:</span></span> 
  
1. <span data-ttu-id="2a9f5-439">발신자 B가 PSTN을 사용 하 여 수신자의 전화 번호로 전화를 겁니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-439">Caller B dials the callee's phone number using PSTN.</span></span> 
    
2. <span data-ttu-id="2a9f5-440">PSTN 통화는 IP 게이트웨이에서 중재 서버 (Lync server)로 라우팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-440">The PSTN call is routed from the IP gateway to the Mediation Server, which is a Lync server.</span></span> 
    
3. <span data-ttu-id="2a9f5-441">중재 서버는 수신자의 Lync home server 호출을 routs 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-441">The Mediation server routs the call to the callee's Lync home server.</span></span> 
    
4. <span data-ttu-id="2a9f5-442">Lync Server는 Lync 2013에서 수신자의 활성 끝점을 울립니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-442">Lync Server rings the callee's active endpoints on Lync 2013.</span></span> 
    
5. <span data-ttu-id="2a9f5-443">호출이 응답 하지 않으면 통화가 Exchange CAS (통화 라우터)에서 음성 메일 (Exchange UM)으로 라우팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-443">When the call is not answered, the call is routed to voicemail (Exchange UM) on the Exchange CAS (call router).</span></span> 
    
## <a name="meeting-recordings-tab"></a><span data-ttu-id="2a9f5-444">모임 녹음 탭</span><span class="sxs-lookup"><span data-stu-id="2a9f5-444">Meeting Recordings tab</span></span>

### <a name="publish-your-meeting-recordings-on-your-sharepoint-team-site"></a><span data-ttu-id="2a9f5-445">SharePoint 팀 사이트에 모임 기록 게시</span><span class="sxs-lookup"><span data-stu-id="2a9f5-445">Publish your meeting recordings on your SharePoint team site</span></span>

<span data-ttu-id="2a9f5-446">모임 녹음/녹화는 통합 커뮤니케이션의 핵심 구성 요소입니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-446">Meeting recordings are a core component of unified communications.</span></span> <span data-ttu-id="2a9f5-447">모임 녹음을 공유 하는 좋은 방법은 팀 사이트에서 SharePoint 자산 라이브러리를 사용 하 여 모임 기록을 저장 하는 것입니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-447">A good way to share your meeting recordings is to use SharePoint asset libraries on your team sites to store your meeting recordings.</span></span> 
  
<span data-ttu-id="2a9f5-448">클라이언트 제품:</span><span class="sxs-lookup"><span data-stu-id="2a9f5-448">Client products:</span></span> 
  
- <span data-ttu-id="2a9f5-449">Lync 2013</span><span class="sxs-lookup"><span data-stu-id="2a9f5-449">Lync 2013</span></span> 
    
<span data-ttu-id="2a9f5-450">서버 제품:</span><span class="sxs-lookup"><span data-stu-id="2a9f5-450">Server products:</span></span> 
  
- <span data-ttu-id="2a9f5-451">서버 제품:</span><span class="sxs-lookup"><span data-stu-id="2a9f5-451">Server products:</span></span> 
    
- <span data-ttu-id="2a9f5-452">SharePoint 2013</span><span class="sxs-lookup"><span data-stu-id="2a9f5-452">SharePoint 2013</span></span> 
    
<span data-ttu-id="2a9f5-453">준비</span><span class="sxs-lookup"><span data-stu-id="2a9f5-453">Prerequisites:</span></span> 
  
- <span data-ttu-id="2a9f5-454">Lync 2013-모임 녹음은 Lync 2013의 클라이언트 쪽 기능입니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-454">Lync 2013 — Meeting recording is a client-side feature in Lync 2013.</span></span> 
    
- <span data-ttu-id="2a9f5-455">SharePoint 2013-팀 사이트에 이미 모임 기록을 저장 하 고 실행 중 이어야 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-455">SharePoint 2013 — You have the team site where you want to store the meeting recordings already up and running.</span></span> 
    
 <span data-ttu-id="2a9f5-456">**기록 되는 기능은 무엇입니까?**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-456">**What is recorded?**</span></span>
  
<span data-ttu-id="2a9f5-457">다음은 모임 중에 MP4 파일에 기록 되며 각 글머리 기호 앞에는 녹음 형식을 나타내는 아이콘이 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-457">The following are recorded into an MP4 file during the meeting (each bullet point is preceded with an icon representing the type of recording):</span></span> 
  
- <span data-ttu-id="2a9f5-458">모든 오디오</span><span class="sxs-lookup"><span data-stu-id="2a9f5-458">All audio</span></span> 
    
- <span data-ttu-id="2a9f5-459">활성 발표자 비디오 (사용 된 경우)</span><span class="sxs-lookup"><span data-stu-id="2a9f5-459">Active speaker's video (if used)</span></span> 
    
- <span data-ttu-id="2a9f5-460">파노라마 비디오 (사용 하는 경우)</span><span class="sxs-lookup"><span data-stu-id="2a9f5-460">Panorama video (if used)</span></span> 
    
- <span data-ttu-id="2a9f5-461">제공 되는 모든 콘텐츠</span><span class="sxs-lookup"><span data-stu-id="2a9f5-461">All content that is presented</span></span> 
    
- <span data-ttu-id="2a9f5-462">인스턴트 메시지 \*</span><span class="sxs-lookup"><span data-stu-id="2a9f5-462">Instant messages\*</span></span> 
    
<span data-ttu-id="2a9f5-463">\* 모임 내의 인스턴트 메시지만 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-463">\*Only the instant messages within the meeting are included.</span></span> <span data-ttu-id="2a9f5-464">모임 참가자 간의 모든 피어 투 피어 메시징은 모임에 포함 되지 않으므로 캡처되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-464">Any peer-to-peer messaging between meeting participants is not part of the meeting and therefore is not captured.</span></span> 
  
<span data-ttu-id="2a9f5-465">포스터에는 두 가지 서로 다른 시나리오에 대 한 두 가지 다이어그램이 포함 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-465">The poster includes two diagrams for two different scenarios:</span></span> 
  
- <span data-ttu-id="2a9f5-466">모임 기록 게시 준비</span><span class="sxs-lookup"><span data-stu-id="2a9f5-466">Preparing for publishing meeting recordings</span></span> 
    
- <span data-ttu-id="2a9f5-467">Lync 클라이언트를 사용 하 여 모임 기록 및 게시</span><span class="sxs-lookup"><span data-stu-id="2a9f5-467">Recording and publishing a meeting using the Lync client</span></span> 
    
### <a name="preparing-for-publishing-meeting-recordings"></a><span data-ttu-id="2a9f5-468">모임 기록 게시 준비</span><span class="sxs-lookup"><span data-stu-id="2a9f5-468">Preparing for publishing meeting recordings</span></span>

<span data-ttu-id="2a9f5-469">이 다이어그램에는 SharePoint Server 2013이 팀 사이트, 중앙 관리 센터 및 IIS (인터넷 정보 서비스) 서버와 함께 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-469">The diagram shows SharePoint Server 2013 with a Team Site, Central Administration center, and Internet Information Services (IIS) Server.</span></span> 
  
<span data-ttu-id="2a9f5-470">팀 사이트에는 다음이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-470">The Team site contains:</span></span> 
  
- <span data-ttu-id="2a9f5-471">자산 라이브러리 앱</span><span class="sxs-lookup"><span data-stu-id="2a9f5-471">The Asset Library app.</span></span> 
    
- <span data-ttu-id="2a9f5-472">팀 구성원이 모임 녹음/녹화를 보내는 모임 자산 라이브러리</span><span class="sxs-lookup"><span data-stu-id="2a9f5-472">Meetings asset library, to which team members send meeting recordings.</span></span> 
    
<span data-ttu-id="2a9f5-473">중앙 관리 센터에는 웹 응용 프로그램 일반 설정이 포함 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-473">The Central Administration Center contains web application general settings.</span></span> 
  
<span data-ttu-id="2a9f5-474">IIS 서버에는 IIS 설정이 포함 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-474">The IIS Server contains IIS settings.</span></span> 
  
<span data-ttu-id="2a9f5-475">모임 기록 게시를 준비 하려면 다음을 수행 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-475">To prepare for publishing meeting recordings:</span></span> 
  
1. <span data-ttu-id="2a9f5-476">SharePoint 팀 사이트에서 자산 라이브러리 앱을 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-476">On your SharePoint team site, add the Asset Library app.</span></span> <span data-ttu-id="2a9f5-477">필요한 경우 크기 제한 또는 연결 시간 제한으로 인해 모임 기록을 업로드할 수 없는 경우 2 단계와 3 단계의 추가 작업을 수행 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-477">Optionally, if you are unable to upload meeting recordings due to size restrictions or connection timeouts, perform the additional steps 2 and 3.</span></span> 
    
2. <span data-ttu-id="2a9f5-478">SharePoint 중앙 관리에서 팀 사이트 모음이 포함 된 웹 응용 프로그램에 대 한 최대 업로드 크기 설정을 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-478">In the SharePoint Central Administration, change the maximum upload size setting for the web application that contains your team site collection.</span></span> 
    
3. <span data-ttu-id="2a9f5-479">IIS 서버 설정에서 팀 사이트 모음이 포함 된 웹 사이트에 대 한 IIS 연결 시간 제한을 늘립니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-479">In the IIS Server settings, increase the IIS connection timeout for the web site that contains your team site collection.</span></span> 
    
 <span data-ttu-id="2a9f5-480">**디지털 자산 라이브러리**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-480">**Digital asset libraries**</span></span>
  
<span data-ttu-id="2a9f5-481">디지털 자산 라이브러리는 특정 용량 및 성능에 영향을 주는 비디오를 포함 하는 자산 라이브러리입니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-481">Digital asset libraries are asset libraries that contain videos that have certain capacity and performance implications.</span></span> <span data-ttu-id="2a9f5-482">자세한 내용은에 http://aka.ms/O1vq5w있는 SharePoint Server 2013에서 디지털 자산 라이브러리 계획을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-482">For more information, see Plan digital asset libraries in SharePoint Server 2013 located at http://aka.ms/O1vq5w.</span></span> <span data-ttu-id="2a9f5-483">또한 포스터에는이 정보에 액세스할 수 있는 QR 코드가 포함 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-483">The poster also includes a QR code to access this information.</span></span> 
  
### <a name="recording-and-publishing-a-meeting-using-the-lync-client"></a><span data-ttu-id="2a9f5-484">Lync 클라이언트를 사용 하 여 모임 기록 및 게시</span><span class="sxs-lookup"><span data-stu-id="2a9f5-484">Recording and publishing a meeting using the Lync client</span></span>

<span data-ttu-id="2a9f5-485">이 다이어그램은 Lync를 사용 하 여 모임에 참가 하는 사용자를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-485">The diagram shows a user using Lync to join a meeting.</span></span> <span data-ttu-id="2a9f5-486">모임이 Lync 클라이언트를 사용 하 여 기록 되며,이는 모임 콘텐츠를 사용 하 여 MP4 파일을 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-486">The meeting is recorded using the Lync client, which creates an MP4 file with the meeting content.</span></span> <span data-ttu-id="2a9f5-487">MP4 녹음은 컴퓨터의 Lync 기록 폴더에 저장 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-487">The MP4 recording is saved to the Lync recording folder on your computer.</span></span> <span data-ttu-id="2a9f5-488">MP4 기록을 wiki, SharePoint 페이지 또는 블로그에 삽입할 수 있는 모임 자산 라이브러리로 이동할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-488">You can move the MP4 recording to your meetings asset library, from which you can insert it into a wiki, SharePoint page, or blog.</span></span> 
  
 <span data-ttu-id="2a9f5-489">**Lync 클라이언트를 사용 하 여 모임 기록 및 게시**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-489">**To record and publish a meeting using the Lync client**</span></span>
  
1. <span data-ttu-id="2a9f5-490">Lync 클라이언트를 사용 하 여 모임 녹음을 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-490">Start recording the meeting using the Lync client.</span></span> 
    
2. <span data-ttu-id="2a9f5-491">모임 중에 모임 콘텐츠가 MP4 파일에 기록 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-491">The meeting content is recorded into an MP4 file during the meeting.</span></span> 
    
3. <span data-ttu-id="2a9f5-492">모임이\\종료 되 면 컴퓨터의 기록 폴더에 MP4 녹음 (C: Users\\<username>\\동영상\\Lync 녹음)이 표시 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-492">After the meeting concludes, the MP4 recording appears in the recording folder on your computer (C:\\Users\\<username>\\Videos\\Lync Recordings).</span></span> <span data-ttu-id="2a9f5-493">필요한 경우 Lync 클라이언트와 함께 설치 되는 Lync 레코딩 관리자 앱을 사용 하 여 모임 기록을 사용자 지정할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-493">Optionally, you can customize the meeting recording using the Lync Recording Manager app which gets installed with Lync client.</span></span> 
    
4. <span data-ttu-id="2a9f5-494">모임 녹음을 SharePoint 자산 라이브러리로 끌어서 놓습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-494">Drag and drop the meeting recording into your SharePoint asset library.</span></span> 
    
5. <span data-ttu-id="2a9f5-495">선택 사항: 녹음/녹화를 자산 라이브러리에 추가한 후에는 SharePoint 페이지에 삽입할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-495">Optional: Once the recording is in your asset library, you can insert it in any SharePoint page.</span></span> <span data-ttu-id="2a9f5-496">이 단계에 대 한 자세한 내용은에 http://aka.ms/R61q35있는 Office 365 블로그 항목, SharePoint 및 Lync Online을 사용 하 여 교육 비디오 만들기 및 게시를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-496">For more information about this step, see the Office 365 blog entry, Create and Publish Training Videos with SharePoint and Lync Online, located at http://aka.ms/R61q35.</span></span> 
    
 <span data-ttu-id="2a9f5-497">**비디오 축소판 그림**</span><span class="sxs-lookup"><span data-stu-id="2a9f5-497">**Video thumbnails**</span></span>
  
<span data-ttu-id="2a9f5-498">비디오 축소판 그림을 통해 자산 라이브러리의 모양과 느낌이 향상 됩니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-498">Video thumbnails improve the look and feel of your asset library.</span></span> <span data-ttu-id="2a9f5-499">모임 녹음/녹화를 위한 축소판 그림을 만드는 방법에 대 한 자세한 내용은 위치 http://aka.ms/Kupj85에 있는 비디오 축소판 그림 캡처 또는 변경을 참조 하십시오.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-499">To learn more about creating thumbnails for your meeting recordings, see Capture or change a video thumbnail, located at http://aka.ms/Kupj85.</span></span> <span data-ttu-id="2a9f5-500">또한 포스터에는이 정보에 액세스할 수 있는 QR 코드가 포함 되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="2a9f5-500">The poster also includes a QR code to access this information.</span></span> 
